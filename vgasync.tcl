...
# File: vgasync.tcl
# Generated on: Sun May 17 18:12:14 2015
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "vgasync"]} {
		puts "Project vgasync is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists vgasync]} {
		project_open -revision vgasync vgasync
	} else {
		project_new -revision vgasync vgasync
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "14:15:09  MAY 17, 2015"
	...
	set_global_assignment -name VERILOG_FILE vgasync.verilog
